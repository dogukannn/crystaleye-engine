...
namespace CrystalEye
{
    ...
    void CEPipeline::Initialize(VkDevice device, VkExtent2D extent, VkFormat colorFormat)
    {
        ...
        VK_CHECK(vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &vPipelineLayout));
        ...
        VK_CHECK(vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &vPipeline)); 
    }
    ...
    void CEPipeline::Destroy(VkDevice device)
    {
        vkDestroyPipeline(device, vPipeline, nullptr);
        vkDestroyPipelineLayout(device, vPipelineLayout, nullptr);
